...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin-sertifikasi-results.store_certificate', $registration->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <a href="{{ route('admin-sertifikasi-results') }}" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
</div>
