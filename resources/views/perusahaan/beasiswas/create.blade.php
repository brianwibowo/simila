...
@section('content')
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ajukan Batch Beasiswa Talent Scouting Baru</h1>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Detail Batch Beasiswa</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('perusahaan-beasiswa-store') }}" method="POST">
                    @csrf

                    <div class="mb-4">
                        <label for="nama_siswa" class="form-label font-weight-bold">Nama Batch</label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-graduation-cap"></i></span>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                name="nama" value="{{ old('nama') }}"
                                placeholder="Contoh: Beasiswa Dev Talenta Q3 2025" required>
                        </div>
                        @error('nama_siswa')
                        ...
                        @enderror
                        <div id="namaHelp" class="form-text">Berikan nama batch beasiswa yang menarik dan informatif.</div>
                    </div>
