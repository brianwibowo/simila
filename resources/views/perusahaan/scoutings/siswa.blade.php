        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('perusahaan-scouting-index') }}">Daftar Batch</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ $pelamar->user->name }}</li>
                </ol>
            </nav>
        </div>
        <a href="{{ route('perusahaan-scouting-show', $pelamar->batch->id) }}" class="btn btn-secondary shadow-sm">
