    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h1 class="h4 mb-4">Ajukan Kurikulum Atas Nama Sekolah</h1>
                    
                    <div class="alert alert-info mb-4">
                        <i class="bi bi-info-circle me-2"></i>
                        Sebagai admin, Anda membantu waka kurikulum untuk mengajukan kurikulum ke perusahaan.
                    </div>
                    
                    <form action="{{ route('admin-kurikulum-store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="submission_type" value="school">
