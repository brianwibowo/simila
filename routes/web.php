...
Route::middleware(['role:siswa'])->prefix('siswa')->group(function () {
    ...
    Route::middleware(['role:guru'])->prefix('guru')->group(function () {
        ...
        Route::get('/mooc/{mooc}/reflection', [GuruReflectionController::class, 'create'])->name('guru-reflection-create');
        Route::post('/mooc/{mooc}/reflection', [GuruReflectionController::class, 'store'])->name('guru-reflection-store');
