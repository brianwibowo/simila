...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('perusahaan-scouting-index') }}" class="btn btn-secondary shadow-sm">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <hr>
            <div class="text-end">
                <a href="{{ route('perusahaan-scouting-edit', $scouting->id) }}" class="btn btn-warning shadow-sm">
