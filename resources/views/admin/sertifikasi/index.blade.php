...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Manajemen Sertifikasi Kompetensi (Admin)</h1>
        <a href="{{ route('admin-sertifikasi-create') }}" class="btn btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50"></i> Buat Sertifikasi Baru
        </a>
    </div>
    <a href="{{ route('admin-sertifikasi-results') }}" class="btn btn-info shadow-sm mb-3">
                        ...
                        @forelse ($exams as $index => $exam)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin-sertifikasi-show', $exam->id) }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-info-circle"></i> Detail & Pendaftar
                                    </a>
                                    <a href="{{ route('admin-sertifikasi-edit', $exam->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <form action="{{ route('admin-sertifikasi-destroy', $exam->id) }}" method="POST" class="d-inline"
