...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h4 mb-0">Tambah Program PKL Baru</h1>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin-pkl-store-for-company', $company->id) }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> Simpan Program PKL
                    </button>
                </div>
            </form>
        </div>
