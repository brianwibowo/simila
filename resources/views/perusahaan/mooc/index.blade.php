...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('perusahaan-mooc-create') }}" class="btn btn-success">
                ...
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-footer bg-white">
                        <div class="btn-group w-100" role="group">
                            ...
                            <a href="{{ route('perusahaan-mooc-show', ['mooc' => $mooc->id]) }}" class="btn btn-outline-info btn-sm">
                                <i class="bi bi-eye"></i> Detail
                            </a>
                            <a href="{{ route('perusahaan-mooc-edit', ['mooc' => $mooc->id]) }}" class="btn btn-outline-warning btn-sm">
                        ...
                        <form id="deleteForm{{ $mooc->id }}" action="{{ route('perusahaan-mooc-destroy', ['mooc' => $mooc->id]) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
                    </div>
