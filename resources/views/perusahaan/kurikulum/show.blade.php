                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            @if($source == 'validasi')
                                <a href="{{ route('perusahaan-kurikulum-list-validasi') }}" class="btn btn-secondary d-flex align-items-center">
                                    <i class="bi bi-arrow-left me-2"></i> Kembali
                                </a>
                            @else
                                <a href="{{ route('perusahaan-kurikulum-list-diajukan') }}" class="btn btn-secondary d-flex align-items-center">
                                    <i class="bi bi-arrow-left me-2"></i> Kembali
                                </a>
                            @endif
                        </div>
                                        ...
                                        <div class="d-grid gap-2">
                                            @if($source == 'validasi')
                                                @if($kurikulum->validasi_perusahaan == 'proses')
                                                    <form action="{{ route('perusahaan-kurikulum-setuju', $kurikulum) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                            ...
                                            @else
                                                @if($kurikulum->validasi_sekolah != 'disetujui')
                                                    <a href="{{ route('perusahaan-kurikulum-edit', $kurikulum) }}" class="btn btn-warning">
                                                        <i class="bi bi-pencil me-1"></i> Edit Kurikulum
                                                    </a>
                                                    <form action="{{ route('perusahaan-kurikulum-destroy', $kurikulum) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kurikulum ini?')">
                                                        @csrf
                                                        @method('DELETE')
