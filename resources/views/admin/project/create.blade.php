...
@section('content')
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h4 mb-0">Tambah Project Mitra</h1>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin-project-store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="file_brief" class="form-label">File Brief <span class="text-danger">*</span></label>
                        <input type="file" name="file_brief" id="file_brief" class="form-control @error('file_brief') is-invalid @enderror" required>
                        <small class="text-muted">Hanya file PDF, DOC, atau DOCX. Maksimal 10MB.</small>
                        @error('file_brief')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
